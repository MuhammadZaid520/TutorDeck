      ...
      <div className="flex-1 flex flex-col items-center justify-center p-8 relative z-10 w-full lg:w-1/2">
        ...
        >
          ...
          <div className="mb-10 text-center flex flex-col items-center">
            ...
            <h2 className="text-xl font-bold text-gray-900 font-display">Create your workspace</h2>
            <p className="text-sm text-gray-500 mt-1">Get started with TutorDeck in seconds.</p>
          </div>
          ...
          <form onSubmit={handleSignup} className="space-y-5">
            ...
            >
              {auth.isLoading ? "Creating account…" : "Create Workspace →"}
            </button>
          ...
          <p className="text-center mt-6 text-sm text-gray-500 font-medium">
            ...
            <button className="text-[#C6551E] font-bold hover:underline" onClick={() => navigate("/login")}>
              Sign in
            </button>
          </p>
        </div>
